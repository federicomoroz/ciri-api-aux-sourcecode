...
```
n8n (38 nodes, explicit) = orchestrator — every step is a named, visible node
...
### n8n Flow (38 nodes: 32 exec + 6 sticky)
...
├── .env.example
├── n8n/
│   └── workflow_ciri_agent.json      # DELIVERABLE: 38 nodes (32 exec + 6 sticky)
├── scripts/
