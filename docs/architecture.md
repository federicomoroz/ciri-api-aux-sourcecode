...
quest_ML/
  ...
  tests/                      # 972 tests (unit + integration + E2E)
  docs/
...
972 tests en 38 archivos (unit + integration + E2E) y **92% de cobertura** sobre `api/app`.
