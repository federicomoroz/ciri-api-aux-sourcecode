...
quest_ML/
  ...
  tests/                      # 1036 tests (unit + integration + E2E)
  docs/
...
1036 tests en 38 archivos (unit + integration + E2E) y **92% de cobertura** sobre `api/app`.
