...
quest_ML/
  ...
  tests/                      # 1006 tests (unit + integration + E2E)
  docs/
...
1006 tests en 38 archivos (unit + integration + E2E) y **92% de cobertura** sobre `api/app`.
