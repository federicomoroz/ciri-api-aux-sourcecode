...
quest_ML/
  ...
  tests/                      # 1030 tests (unit + integration + E2E)
  docs/
...
1030 tests en 38 archivos (unit + integration + E2E) y **92% de cobertura** sobre `api/app`.
